...
import { XIcon, User, Calendar } from "lucide-react"
...
const COMMON_REASONS = [
  ...
  "Need more information about the agenda",
  "Other",
]

export default function RejectReasonModal({ request, onConfirm, onCancel, isLoading }) {
        ...
        <div className="p-6 overflow-y-auto">
          ...
          <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 mb-6">
            <p className="text-amber-800 dark:text-amber-200 text-sm">
              <strong>Note:</strong> The mentee will be notified about the rejection. Providing a reason helps them
              understand and potentially reschedule.
            </p>
          </div>
