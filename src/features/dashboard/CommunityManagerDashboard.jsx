...
export default function CommunityManagerDashboard({ data }) {
  ...
  console.log("CommunityManagerDashboard data:", data);
  ...
  const profileSteps = [
    ...
    { key: "hasCommunity", label: "Community Created", completed: !!profileSetup?.hasCommunity },
  ];
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4 p-3 rounded-lg bg-gray-50 dark:bg-gray-700">
              ...
              <div className="flex-1">
                <div className="flex items-center">
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white">{community.name}</h4>
                  {community.verified && <CheckCircle className="h-4 w-4 text-blue-500 ml-2" />}
                </div>
            ...
            <div className="grid grid-cols-2 gap-4 pt-3 border-t border-gray-200 dark:border-gray-700">
              <div className="flex flex-col items-center">
                <div className="flex items-center text-gray-800 dark:text-gray-200">
                  ...
                  <span className="text-lg font-bold">{community.membersCount || 0}</span>
                </div>
              ...
              <div className="flex flex-col items-center">
                <div className="flex items-center text-gray-800 dark:text-gray-200">
                  ...
                  <span className="text-lg font-bold">{new Date(community.createdAt).getFullYear()}</span>
                </div>
        ...
        {joinRequests.length > 0 ? (
          <div className="space-y-4">
              ...
              <div key={request.id} className="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-700">
                <div className="flex items-center space-x-4">
                  {request.userImageUrl ? (
                    <img
                      src={request.userImageUrl || "/placeholder.svg"}
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-semibold text-gray-900 dark:text-white truncate">{request.userName}</p>
            ...
            {joinRequests.length > 5 && (
              <p className="text-sm text-center text-gray-500 dark:text-gray-400 mt-4">+{joinRequests.length - 5} more</p>
            )}
          </div>
        ) : (
