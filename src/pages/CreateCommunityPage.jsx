...
function CreateCommunityContent() {
  ...
  //   useCheckExistingCommunity(user?.id);
  ...
  // useEffect(() => {
  //   if (existingCommunity && !checkingExisting) {
  //     navigate(`/communities/${existingCommunity.id}`);
  //   }
...
function CommunityManagerOnlyFallback() {
